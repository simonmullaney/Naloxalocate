...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Spcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"simoncointools.com", "34.196.229.40"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"simoncointools.com", "testnet-seed.simoncointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Spcoin is probably already running."), addrBind.ToString().c_str());
        else
